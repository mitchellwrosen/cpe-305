...
protected:
   ...
   inline void HalfPut(Spot *spt) const {
      ((spt->empty) ? static_cast<void> (0) : __assert_fail ("spt->empty", "../../PylosBoard.h", 143, __PRETTY_FUNCTION__));
      spt->top = spt->empty;
   ...
   inline void HalfTake(Spot *spt) const {
      ...
      ((spt->top) ? static_cast<void> (0) : __assert_fail ("spt->top", "../../PylosBoard.h", 156, __PRETTY_FUNCTION__));
      spt->empty = spt->top;
...
public:
   ...
   void OperatorEqEq() {
      ...
      ((move1 == move2) ? static_cast<void> (0) : __assert_fail ("move1 == move2", "PylosTest.cpp", 22, __PRETTY_FUNCTION__));


      move2 = PylosMove(locs2, PylosMove::kPromote);
      ((!(move1 == move2)) ? static_cast<void> (0) : __assert_fail ("!(move1 == move2)", "PylosTest.cpp", 26, __PRETTY_FUNCTION__));


      locs2.push_back(std::make_pair(2,2));
      move2 = PylosMove(locs2, PylosMove::kReserve);
      ((!(move1 == move2)) ? static_cast<void> (0) : __assert_fail ("!(move1 == move2)", "PylosTest.cpp", 31, __PRETTY_FUNCTION__));
   }
   ...
   PylosTest() {
      do { TestObj temp("NewDelete", &NewDelete); mTests.push_back(temp); } while (0);
      do { TestObj temp("OperatorEqEq", &OperatorEqEq); mTests.push_back(temp); } while (0);
      do { TestObj temp("OperatorLessThan", &OperatorLessThan); mTests.push_back(temp); } while (0);
   }
};
